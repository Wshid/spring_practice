...
public class BController {
	...
	public String list(Model model) {
		System.out.println("list()"); // 로그 메세지 
	...
	public String write(HttpServletRequest request, Model model) { //작성한 데이터를 받기 위해 request 객체를 사용한다 
		System.out.println("write()");
		
		model.addAttribute("request", request); // 모델에 인자를 넘긴다 
